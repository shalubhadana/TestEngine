...
<div class="container">
<h2><B><p>TestEngine Online Test on <%=(String)session.getAttribute("sub") %> </p></B></h2>

<%

Class.forName("com.mysql.jdbc.Driver").newInstance();
Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/Testengine","root", "");
